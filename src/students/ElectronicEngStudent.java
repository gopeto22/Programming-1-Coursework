...
public class ElectronicEngStudent implements
    Student { //creating the public class Electronic Engineering student which implements the interface Student
  ...
  int attack = 9;//creating a variable called attack which represents the attack power of the student and assigning it with the value of 7
  int delay = 8;//creating a variable called delay which represents the delay steps of the student and assigning it with the value of 4

  public ElectronicEngStudent(
      int level) {//creating the constructor of Electronic Engineering Student which takes int variable called level as parameter
  ...
  public int defence(
    ...
    if (building.getAllBugs().length
      ...
      int specialAttack = level + 1;//creating int variable called special attack
      if (counter
