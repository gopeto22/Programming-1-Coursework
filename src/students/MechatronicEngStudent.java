...
public class MechatronicEngStudent implements Student {//creating the public class Biomedical Engineering student which implements the interface Student
  ...
  public int defence(
    ...
    if (building.getAllBugs().length == 0) {//checking if the getAllBugs method contains in bugs.txt in itself
      ...
      int specialAttack =
          normalAttack *3;//creating int variable called special attack
      if (counter
        ...
        bug1.damage(
            specialAttack);//the student doing a special attack and causing damage to the first bug
        bug2.damage(specialAttack);//the student doing a special attack and causing damage to the first bug
        bug3.damage(specialAttack);//the student doing a special attack and causing damage to the first bug
