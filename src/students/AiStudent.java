...
public class AiStudent implements
    Student {//creating the public class Ai student which implements the interface Student
  ...
  int delay = 7;//creating a variable called delay which represents the delay steps of the student and assigning it with the value of 7

  public AiStudent(
      int level) {//creating the constructor of Ai student which takes int variable called level as parameter
  ...
  public int defence(
    ...
    if (building.getAllBugs().length == 0) {//checking if the getAllBugs method contains in bugs.txt in itself
      ...
      if (counter
        ...
        bug1.damage(
            specialAttack);//the student doing a special attack and causing damage to the second bug
        bug2.damage(
            specialAttack);//the student doing a special attack and causing damage to the third bug
