...
public class AerospaceElecStudent implements
    Student { //creating the public class Aerospace Electrical student which implements the interface Student
  ...
  int delay = 3;//creating a variable called delay which represents the delay steps of the student and assigning it with the value of 3

  public AerospaceElecStudent(
      int level) {//creating the constructor of Aerospace Electrical Student which takes int variable called level as parameter
    ...
    {//overriding the defence method declared in the Student interface
      if (building.getAllBugs().length
        ...
        int specialAttack = normalAttack
            * 3;//creating int variable called special attack which is equal to the normal attack
