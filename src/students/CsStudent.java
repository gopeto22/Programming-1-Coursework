...
public class CsStudent implements
    Student {//creating the public class Cs student which implements the interface Student
  ...
  int attack = 6;//creating a variable called attack which represents the attack power of the student and assigning it with the value of 6
  ...
  public int defence(Building building) {//overriding the defence method declared in the Student interface
    if (building.getAllBugs().length == 0) {//checking if the getAllBugs method contains in bugs.txt in itself
      ...
      int specialAttack = 4
          * normalAttack;//creating int variable called special attack which is 4 times bigger than the normal attack
