...
public class ElectricalandElectronicEngStudent implements
    Student { //creating the public class Electrical and Electronic Engineering student which implements the interface Student
  ...
  int attack = 4;//creating a variable called attack which represents the attack power of the student and assigning it with the value of 5
  int delay = 6;//creating a variable called delay which represents the delay steps of the student and assigning it with the value of 8

  public ElectricalandElectronicEngStudent(
      int level) {//creating the constructor of Electrical and Electronic Engineering student which takes int variable called level as parameter
  ...
  public int defence(
    ...
    if (building.getAllBugs().length
      ...
      Bug bug3 = building.getAllBugs()[3];//creating a new bug and assigning its place as the third in the array created by getAllBugs method in building class
      Bug bug4 = building.getAllBugs()[4];//creating a new bug and assigning its place as the third in the array created by getAllBugs method in building class
      Bug bug5 = building.getAllBugs()[5];//creating a new bug and assigning its place as the third in the array created by getAllBugs method in building class
      ...
      int specialAttack = normalAttack;//creating int variable called special attack
      if (counter
        ...
        bug.slowDown(5);//slowing the first bug with 5 steps
        bug1.slowDown(5);//slowing the second bug with 5 steps
        bug2.slowDown(5);//slowing the third bug with 5 steps
        bug3.slowDown(5);//slowing the fourth bug with 5 steps
        bug4.slowDown(5);//slowing the fifth bug with 5 steps
        if (bug.getCurrentHp() == 0) {//checking if the bug current HP are equal to 0
          ...
          building.removeBug(bug5);//removing the bug if the building in case the HP are equal to 0
          knowledgePoints = (bug.level)
              * 20;//rising the knowledge points with the level times the bug and times 20
        }
